      ...
      <table>
        <tbody>
          ...
          <tr>
            <td>onClick</td>
            <td>
              <button onClick={(event) => console.log("onClick")}>
                {" "}
                onClick{" "}
              </button>
            </td>
          ...
          <tr>
            <td>onDoubleClick</td>
            <td>
              <button onDoubleClick={(event) => console.log("onDoubleClick")}>
                {" "}
                onDoubleClick{" "}
              </button>
            </td>
          ...
          <tr>
            ...
            <td>
              <input
                onDragStart={(event) => console.log("dragStart")}
